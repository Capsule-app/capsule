...
export const CreatePostModal: React.FC<Props> = ({
  ...
  const [useCreatePost] = useMutation(createPostMutation);
    ...
    >
      ...
      >
        ...
        <div className="flex pt-2 space-x-3 col-span-full items-center">
          <button className="focus outline-none focus:ring-4 focus:ring-secondary-ring font-serif text-sm text-white font-bold py-2 px-6 rounded-lg transition duration-200 ease-in-out bg-blue">
            Create Post
          </button>
        </div>
      </form>
